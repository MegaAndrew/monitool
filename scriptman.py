#!/usr/bin/env python3
"""
ScriptMan - Shell Script Manager
Run: python scriptman.py
...
CONFIG_FILE = os.environ.get("SCRIPTMAN_CONFIG", "scripts.json")
SECRET_KEY = os.environ.get("SCRIPTMAN_SECRET", secrets.token_hex(32))
HOST = os.environ.get("SCRIPTMAN_HOST", "127.0.0.1")
PORT = int(os.environ.get("SCRIPTMAN_PORT", "7000"))
...
log = logging.getLogger("scriptman")
...
if __name__ == "__main__":
    ...
    get_config()
    log.info(f"ScriptMan starting on http://{HOST}:{PORT}")
